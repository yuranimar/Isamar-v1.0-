...
export default function Navbar() {
  ...
  const navBg = scrolled || menuOpen
    ? 'bg-[#F8F0F0]/95 backdrop-blur-md shadow-[0_1px_0_rgba(139,58,69,0.08)]'
    : 'bg-transparent'
        ...
        <div className="flex items-center justify-between px-5 md:px-12 py-3.5">
          ...
          <a href="#" onClick={() => setMenuOpen(false)} className="flex items-center gap-3">
            ...
            <div className="flex flex-col leading-none">
              <span className="font-serif text-lg font-semibold text-[#8B3A45] tracking-wide">
                ISAMAR
              </span>
              <span className="text-[0.55rem] tracking-[0.18em] uppercase text-[#C5A059]">
                Tejidos y Crochet
              </span>
            </div>
          </a>
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="md:hidden w-8 h-8 flex flex-col justify-center gap-1.5 text-[#8B3A45]"
            >
